                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-7 col-md-12 col-custom">
                        <div class="feature-image position-relative">
                            <img src="{{ asset('/') }}front/assets/images/feature/feature-2.jpg" alt="Obrien Feature">
                    ...
                    <div class="col-lg-12 col-custom">
                        ...
                        "slidesToShow": 2
                            ...
                            <div class="brand-logo-item">
                                <a href="#">
                                    <img src="{{ asset('/') }}front/assets/images/brand-logo/brand-1.png" alt="Brand Logo">
                                </a>
                            </div>
                            <div class="brand-logo-item">
                                <a href="#">
                                    <img src="{{ asset('/') }}front/assets/images/brand-logo/brand-2.png" alt="Brand Logo">
                                </a>
                            </div>
                            <div class="brand-logo-item">
                                <a href="#">
                                    <img src="{{ asset('/') }}front/assets/images/brand-logo/brand-3.png" alt="Brand Logo">
                                </a>
                            </div>
                            <div class="brand-logo-item">
                                <a href="#">
                                    <img src="{{ asset('/') }}front/assets/images/brand-logo/brand-4.png" alt="Brand Logo">
                                </a>
                            </div>
                            <div class="brand-logo-item">
                                <a href="#">
                                    <img src="{{ asset('/') }}front/assets/images/brand-logo/brand-5.png" alt="Brand Logo">
                                </a>
                            </div>
                            <div class="brand-logo-item">
                                <a href="#">
